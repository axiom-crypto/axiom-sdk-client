...
circuit
  ...
  .option("-t, --targetChainId <targetChainId>", "(crosschain) target chain id")
  .option("-tr, --targetRpcUrl <targetRpcUrl>", "(crosschain) target chain JSON-RPC provider URL (https)")
  .option("-b, --bridgeId <bridgeId>", "(crosschain) bridge id", parseInt)
  .option("-br, --isBroadcaster", "(crosschain) Use crosschain broadcaster")
  .option("-bo, --isBlockhashOracle", "(crosschain) Use crosschain blockhash oracle")
  .action(queryParams);
