...
export const scaffoldScript = async (sm: ScaffoldManager) => {
  ...
  await sm.exec(`git clone --depth 1 -b staging https://github.com/axiom-crypto/axiom-quickstart.git ${tempDir}`, "Clone Axiom quickstart template");
