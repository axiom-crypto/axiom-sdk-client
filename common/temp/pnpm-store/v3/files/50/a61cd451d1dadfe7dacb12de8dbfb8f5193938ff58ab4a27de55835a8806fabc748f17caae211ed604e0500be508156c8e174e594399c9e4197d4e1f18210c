...
import { type GetCallsReceiptParameters, type GetCallsReceiptReturnType } from '../actions/getCallsReceipt.js';
...
export type WalletActionsEip5792<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
     ...
     */
    getCallsReceipt: (parameters: GetCallsReceiptParameters) => Promise<GetCallsReceiptReturnType>;
    /**
