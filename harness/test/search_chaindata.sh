...
# node dist/cli/index.js search --rpc-url $RPC_URL_84532 --include 8285121 --output ./output
# node dist/cli/index.js search --rpc-url $RPC_URL_8453 --include 13006428 --output ./output
